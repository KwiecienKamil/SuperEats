  ...
  return (
    <div onClick={props.onCloseSideModal}>
        ...
        <div className="w-[95%] flex items-center justify-center gap-4 sm:gap-8 text-[12px] sm:text-[17px] pt-[30px] pb-8 border-b border-darkerGray">
          <div className="flex flex-col items-center justify-center">
            <img
              ...
              className="max-h-[25px] sm:max-h-[40px] hover:bg-gray rounded-full cursor-pointer"
              alt="pizza"
            />
            <p>All</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            <img
              ...
              src="https://d4p17acsd5wyj.cloudfront.net/shortcuts/cuisines/healthy.png"
              className="max-h-[25px] sm:max-h-[40px] hover:bg-gray rounded-full cursor-pointer"
              alt="asian"
            />
            <p>Healthy</p>
          ...
          <div className="flex flex-col items-center justify-center">
            <img
              ...
              src="https://d4p17acsd5wyj.cloudfront.net/shortcuts/cuisines/mexican.png"
              className="max-h-[25px] sm:max-h-[40px] hover:bg-gray rounded-full cursor-pointer"
              alt="mexican"
            />
            <p>Mexican</p>
          ...
          <div className="flex flex-col items-center justify-center">
            <img
              ...
              src="https://d4p17acsd5wyj.cloudfront.net/shortcuts/cuisines/dessert.png"
              className="max-h-[25px] sm:max-h-[40px] hover:bg-gray rounded-full cursor-pointer"
              alt="dessert"
            />
            <p>Dessert</p>
      ...
      <div className="w-full pt-4">
        <h1 className="text-center text-main text-xl sm:text-3xl font-Poppins font-semibold">
          ...
          {data.map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between px-[1px] sm:px-2 py-4">
                <p className="font-bold text-[10px] sm:text-[20px]">
                  {item.name}
                </p>
                <p>
